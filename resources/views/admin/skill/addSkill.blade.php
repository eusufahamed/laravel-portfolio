    ...
    <div class="col-sm-12 col-md-8 col-md-offset-2">
      ...
      <div class="panel b-primary bt-md">
        <div class="panel-content">
          <div class="row">
            <div class="col-xs-6"><h5>Member Skill Add Form</h5></div>
            <div class="col-xs-6 text-right">
              <a href="{{ route('skillLists') }}" class="btn btn-primary">All Skill</a>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">

              <form action="{{ route('storeSkill') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="text1" name="skillName" value="{{ old('skillName') }}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="number" class="form-control" id="num1" name="percentage" value="{{ old('percentage') }}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  <div class="col-sm-offset-2 col-sm-10">
                    ...
                    <input type="submit" value="Add Skill" class="btn btn-primary btn-xs">
                  </div>
                </div>
              </form>
