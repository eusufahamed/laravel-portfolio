    ...
    <div class="col-sm-12 col-md-8 col-md-offset-2">
      ...
      <div class="panel b-primary bt-md">
        <div class="panel-content">
          <div class="row">
            <div class="col-xs-6"><h5>Project Edit Form</h5></div>
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <form action="{{ route('updatedProject', $project->id) }}" class="form-horizontal" method="post" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                  <label for="text1" class="col-sm-2 control-label">Title</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="text1" name="title" value="{{ $project->title }}">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select id="select1" class="form-control" name="category">
                      ...
                      <option value="{{ $category->id }}" {{ old('category_id', $project->category_id) == $category->id ? 'selected' : '' }}>{{ ucwords($category->name) }}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select id="select2" class="form-control" name="service">
                      ...
                      <option value="{{ $service->id }}" {{ old('service_id', $project->service_id) == $service->id ? 'selected' : '' }}>{{ ucwords($service->name) }}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select id="select3" class="form-control" name="client">
                      ...
                      <option value="{{ $client->id }}" {{ old('client_id', $project->client_id) == $client->id ? 'selected' : '' }}>{{ ucwords($client->name) }}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select id="select4" class="form-control" name="team">
                      ...
                      <option value="{{ $team->id }}" {{ old('team_id', $project->team_id) == $team->id ? 'selected' : '' }}>{{ ucwords($team->name) }}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <textarea class="form-control" id="description1" name="description" rows="5">{{ $project->description }}</textarea>
                ...
                <div class="form-group">
                  <div class="col-sm-offset-2 col-sm-10">
                    ...
                    <input type="submit" value="Update Project" class="btn btn-primary btn-xs">
                    <a href="{{ route('deleteProject', $project->id) }}" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete</a>
                  </div>
                </div>
              </form>
